...
#define STR_FILENAME_1 "daten_kasse_1.klm"					// primהre Dateiname
...
#define STR_COPY_PRE "kopie_"								// Prהfix für die Kopien
...
#define STR_FILE_CORRUPT "\n Die aktuelle Datei (Kasse Nr. %i) ist besch„digt!\n"\
						 " ממממממממממממממממממממממממממממממממממממממממממממממממ\n"\
...
#define STR_OUTPUT_SUM "Summe dieses Kunden"							// diverse Bestהtigungen
