...
#define BUFFER_SIZE 37							// legt fest wie viele zeichen man maximal in eine Spalte schreiben kann
#define POSITION_PRICE (BUFFER_SIZE + 6)		// legt fest an welcher Position die zweite Spalte beginnt
